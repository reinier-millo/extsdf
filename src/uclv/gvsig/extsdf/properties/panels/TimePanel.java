...
public class TimePanel extends AbstractPanel {
	...
	public TimePanel() {
		...
		gbl_panel.columnWidths = new int[]{134, 100, 0, 58, 0, 96, 0, 0};
		gbl_panel.rowHeights = new int[]{24, 15, 24, 24, 19, 25, 0};
		...
		gbl_panel_1.columnWidths = new int[]{148, 101, 116, 114, 0, 0};
		gbl_panel_1.rowHeights = new int[]{24, 24, 0};
		...
		gbc_time_offset.gridx = 0;
		gbc_time_offset.gridy = 1;
